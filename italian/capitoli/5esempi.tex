...
Per comprendere appieno l'enunciato di tale teorema, richiamiamo insieme ad esso due definizioni.
\begin{definition}
...
\{E_{j,n}\}_{j,n \in \mathbb{N}_0} \subseteq l^{\infty} \text{ tali che } \\
a \in E_{j,n} \text{ se e solo se } \exists \, u \in C^1(A_{j,n}) \text{ tale che }\\
