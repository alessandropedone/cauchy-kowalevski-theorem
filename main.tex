...
\title{Sull'esistenza di soluzioni locali\\di equazioni differenziali\\alle derivate parziali}
\date{\today}
% indice
...
{\LARGE
\textmd{\textbf{Sull'esistenza di soluzioni locali\\di equazioni differenziali\\\vspace*{0.2cm} alle derivate parziali}}
}
